...
This report was generated by the [sdlc plugin](https://github.com/zircote/sdlc-quality).
...
For detailed guidance on each domain, refer to the [sdlc plugin documentation](https://github.com/zircote/sdlc-quality/tree/main/skills).
EOF
...
EOF
  ...
  echo ""
  echo "---"
  echo "*Generated by [sdlc plugin](https://github.com/zircote/sdlc-quality)*"
}
